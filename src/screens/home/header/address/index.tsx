...
const SelectAddress: React.FC<SelectAddressProps> = ({ navigation }) => {
    const [user] = useUser();
    const isAddress = user.address !== null;
    ...
    const text = isAddress ? user!.address : "Veuillez saisir une adresse";

    return (
        <TouchableOpacity style={[styles.container, backgroundColor]} onPress={() => navigation.navigate("SearchAddress")}>
